        ...
        <Container maxWidth="lg" style={{paddingTop: 40}}>
            <Grid container spacing={3} className="blog-app">
                ...
                <Grid item sm={6} xs={12} style={{textAlign: 'left'}}>
                    <span>PRODUCT . Jul 24, 2020</span><br/>
                    <h2>Interview -- Como pasar una entrevista informatica y como pasarla</h2>
                    <p className="text-dark">
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet, animi aspernatur blanditiis
                        dolor dolorem fuga fugiat itaque iure laudantium modi natus nesciunt perferendis quae quos
                        sit velit veniam vitae voluptate.
                    </p>
                    <p className="text-dark">
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet, animi aspernatur blanditiis
                        dolor dolorem fuga fugiat itaque iure laudantium modi natus nesciunt perferendis quae quos
